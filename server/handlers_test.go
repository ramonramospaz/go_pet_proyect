...
func TestFindAndDeleteUserService(t *testing.T) {
	...
	// Test listUsers with no data
	expected := []byte("{\"code\":200,\"message\":\"The user deleted\"}\n")

	req, err = http.NewRequest("DELETE", "/user/15281565", nil)
	...
	expected = []byte("[{\"id\":15281567,\"name\":\"Fabiola Ramos\",\"age\":37,\"birthCountry\":\"Venezuela\"}]\n")
